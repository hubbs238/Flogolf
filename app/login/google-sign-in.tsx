  ...
  return (
    <div className="w-full">
      <button
        onClick={signIn}
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 rounded-xl bg-raised border border-line px-5 py-3.5 font-medium shadow-sm transition hover:border-fairway-300 hover:shadow disabled:opacity-60"
      >
